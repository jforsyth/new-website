...
date: 2019-10-12
published: false
description: Stephen Mitchell presents research on measuring athlete performance at MARCUS conference
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/stephen-mitchell-marcus.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
More information can be found in his [abstract](/assets/pdf/mitchell-marcus-abstract.pdf) and [poster](/assets/pdf/mitchell-marcus-poster.pdf).
